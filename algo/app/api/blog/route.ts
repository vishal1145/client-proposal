...
const blogs = [
  {
    ...
    content: "Technology is transforming the legal industry, enabling automation, AI-driven research, and cloud-based legal services.",
    ...
    quote: { text: "Technology in law is about efficiency & justice.", author: "Legal IT Expert" },
    ...
    testimonial: {
      ...
      person: { name: "Michael Smith", avatar: "/images/user1.jpg", position: "Senior Lawyer" },
    },
  },
  {
    id: 2,
    ...
    content: "Law firms are prime targets for cyber threats. Strong security policies ensure the protection of sensitive legal data.",
    imageUrl: "/images/man.jpg",
    ...
    quote: { text: "Data security isn't an option; it's a necessity.", author: "Cybersecurity Analyst" },
    additionalImages: ["/images/cyberLaw2.jpg", "/images/cyberLaw3.jpg"],
    afterAdditionalImage:["Passkeys replace passwords with cryptographic key pairs stored on a user’s device, making logins phishing-resistant and highly secure. The device generates and stores a secure key pair during registration, and users verify their identity via biometrics or a device PIN. Developers can easily integrate passkeys in Node.js applications using @simplewebauthn/server."],
    social: { twitter: "TW", youtube: "YU", facebook: "FB", linkedin: "IN" },
    testimonial: {
      text: "We significantly reduced breaches using these strategies.",
      person: { name: "Sarah Johnson", avatar: "/images/user2.jpg", position: "IT Director" },
    },
  },
  {
    id: 3,
    ...
    content: "Passkeys and biometrics are transforming Node.js authentication. Say goodbye to passwords and hello to seamless security.",
  ...
  },
  {
    ...
    quote: { text: "AI is the key to unlocking intelligent automation.", author: "AI Engineer" },
    additionalImages: ["/images/nodeAI2.jpg", "/images/nodeAI3.jpg"],
    afterAdditionalImage:["Passkeys replace passwords with cryptographic key pairs stored on a user’s device, making logins phishing-resistant and highly secure. The device generates and stores a secure key pair during registration, and users verify their identity via biometrics or a device PIN. Developers can easily integrate passkeys in Node.js applications using @simplewebauthn/server."],
    social: { twitter: "TW", youtube: "YU", facebook: "FB", linkedin: "IN" },
    testimonial: {
      text: "Using AI in Node.js revolutionized our app experience.",
      person: { name: "Sophia Chang", avatar: "/images/user6.jpg", position: "AI Developer" },
    },
  },
  {
    id: 6,
    ...
    content: "Law firms must follow strict compliance standards to ensure data privacy and regulatory adherence.",
    imageUrl: "/images/man.jpg",
    ...
    quote: { text: "Compliance builds trust in legal IT.", author: "Data Privacy Expert" },
    additionalImages: ["/images/dataProtection2.jpg", "/images/dataProtection3.jpg"],
    afterAdditionalImage:["Passkeys replace passwords with cryptographic key pairs stored on a user’s device, making logins phishing-resistant and highly secure. The device generates and stores a secure key pair during registration, and users verify their identity via biometrics or a device PIN. Developers can easily integrate passkeys in Node.js applications using @simplewebauthn/server."],
    social: { twitter: "TW", youtube: "YU", facebook: "FB", linkedin: "IN" },
    testimonial: {
      text: "Regulatory compliance has secured our legal firm.",
      person: { name: "Emily Carter", avatar: "/images/user4.jpg", position: "Compliance Officer" },
    },
  },
  {
    id: 10,
    ...
    content: "Flask simplifies Python web development, offering flexibility and scalability for developers.",
    ...
    quote: { text: "Flask is a developer-friendly framework.", author: "Python Developer" },
    additionalImages: ["/images/flask2.jpg", "/images/flask3.jpg"],
    afterAdditionalImage:["Passkeys replace passwords with cryptographic key pairs stored on a user’s device, making logins phishing-resistant and highly secure. The device generates and stores a secure key pair during registration, and users verify their identity via biometrics or a device PIN. Developers can easily integrate passkeys in Node.js applications using @simplewebauthn/server."],
    social: { twitter: "TW", youtube: "YU", facebook: "FB", linkedin: "IN" },
    testimonial: {
      text: "Flask made my backend development smoother.",
      person: { name: "Rajiv Das", avatar: "/images/user5.jpg", position: "Software Engineer" },
    },
  },
  {
    id: 11,
    title: "The Future of Intelligence - How Python Powers Artificial Intelligence",
    category: "Artificial Intelligence",
    content: "Python is the backbone of AI, enabling the development of machine learning models and automation solutions.",
    imageUrl: "/images/rajat.jpg",
    ...
    quote: { text: "AI is the future, and Python is leading the way.", author: "AI Researcher" },
    additionalImages: ["/images/pythonAI2.jpg", "/images/pythonAI3.jpg"],
    afterAdditionalImage:["Passkeys replace passwords with cryptographic key pairs stored on a user’s device, making logins phishing-resistant and highly secure. The device generates and stores a secure key pair during registration, and users verify their identity via biometrics or a device PIN. Developers can easily integrate passkeys in Node.js applications using @simplewebauthn/server."],
    social: { twitter: "TW", youtube: "YU", facebook: "FB", linkedin: "IN" },
    testimonial: {
      text: "Python's AI capabilities have been groundbreaking.",
      person: { name: "Sophia Chang", avatar: "/images/user6.jpg", position: "AI Engineer" },
    },
  },
];
