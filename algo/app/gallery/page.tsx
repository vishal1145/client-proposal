        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="text-center max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-4">
              <h1 className="text-3xl font-bold text-[#0B1B2B]">Gallery</h1>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-[1600px] px-8 md:px-12 lg:px-20 relative z-10 py-8">
          <div className="text-center mb-12">
            <span className="w-[198px] text-black h-[30px] px-4 py-1 border border-1 rounded-[60px]">
              Designing IT Services
            </span>
            <p className=" font-['Public_Sans'] mt-1 font-semibold text-[40px] leading-[56px] tracking-[0%]">
              Our Gallery Section
            </p>
          </div>
