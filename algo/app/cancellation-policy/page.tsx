        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <p className="text-[14px] text-gray-700 leading-relaxed">
              At Algofolks, we value our customers and aim to provide seamless IT services including QA, web development, app development, and more. However, we understand that there may be instances where you need to cancel an order or terminate a service agreement.
            </p>
            ...
            <div className="space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-[14px] text-gray-700 leading-relaxed">
                  Clients can request to cancel a service by providing written notice via email to support@algofolks.com. Cancellation requests must be submitted at least 10 business days prior to the scheduled service delivery date or project milestone.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-[14px] text-gray-700 leading-relaxed">
                  For ongoing projects, cancellation will be processed based on the stage of the project. Clients will be charged for the work completed up to the date of cancellation. If cancellation occurs mid-project, Algofolks reserves the right to retain a minimum of 30% of the total project value as compensation for administrative and resource allocation efforts.
                </p>
              </section>
