      ...
      <div className="container mx-auto max-w-[1600px] px-8 md:px-12 lg:px-20 relative z-10 py-8">
        ...
        <div className="space-y-6">
          <p className="text-gray-800 text-[14px]">
            Algofolks (collectively, “Algofolks”, “us” or “we”) understand that
            your privacy is important to you and are committed to being
            transparent about the technologies it uses. This Cookie Policy
            explains how and why cookies, web beacons, pixels, clear gifs, and
            other similar technologies (collectively “Cookies and Other Tracking
            Technologies”) may be stored on and accessed from your device when
            you use or visit any website or app that posts a link to this Policy
            (collectively, “the Sites”). This Cookie Policy should be read
            together with our Privacy Policy and our Terms & Conditions.
          </p>
          ...
          <section>
            ...
            <p className="text-gray-800 text-[14px]">
              ...
              from your device when you visit one of our Sites, to the extent
              you agree. The other tracking technologies work similarly to
              cookies and place small data files on your devices or monitor your
              website activity to enable us to collect information about how you
              use our Sites. This allows our Sites to recognise your device from
              those of other users of the Sites. The information provided below
              about cookies also applies to these other tracking technologies.
          ...
          <section>
            ...
            <p className="text-gray-800 text-[14px]">
              Algofolks uses Cookies and Other Tracking Technologies to identify
            ...
            <p className="text-gray-800 mt-4 text-[14px]">
              To administer our Sites and for research purposes, Algofolks also
              has contracted with third party service providers to track and
              analyse statistical usage and volume information from our Site
              ...
              content, and analyse how users navigate and utilise the Sites.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-800 text-[14px]">
              “First party Cookies” are cookies that belong to Algofolks and
              that Algofolks places on your device. “Third party Cookies” are
              cookies that another party places on your device through our Site.
              Algofolks Sp. z o.o. may contract with third party service
